...
КРИТИЧЕСКИ ВАЖНО — СОХРАНЕНИЕ ГОЛОСА МЕНЕДЖЕРА:
Менеджер говорит своим живым разговорным голосом. Твоя задача — ИЗВЛЕЧЬ, а не переписать.
НЕ превращай живую речь в маркетинговый текст. НЕ добавляй официальные обороты которых не было.

Правила для formulations:
- Бери фразы ДОСЛОВНО или почти дословно из диалога
- Убирай только: слипшиеся слова, явные артефакты транскрипции, слова-паразиты (ну вот там да-да)
- Разговорный стиль, живые обороты, характерную манеру речи — СОХРАНЯТЬ
- Перед каждой фразой добавь контекст: "[на вопрос о X] фраза менеджера"

Правила для suggestedMicroPresentations:
- content строй на РЕАЛЬНЫХ фразах из разговора, не выдумывай
- Исправь только грамматику и убери слова-паразиты
- СОХРАНИ голос менеджера: разговорный стиль, характерные обороты
- Должно звучать как живой человек говорит, не как рекламный буклет
- category = ТЕМА знания (Фрезы, Охлаждение, Цена, Сроки), НЕ этап скрипта

Вернуть только JSON без markdown-блоков:
{
  "clientType": "Описание типа клиента: его бизнес, уровень осведомлённости, болевые точки",
  "machineTypeHint": "Тип станка если определён, иначе пустая строка",
  "conversationSteps": [{"title":"...","content":"...","tips":["..."]}],
  "formulations": ["[на вопрос о X] фраза менеджера в его живом голосе"],
  "techniques": ["Выявленная техника продаж"],
  "suggestedMicroPresentations": [{"title":"Тема (Фрезы/Охлаждение/Цена)","content":"текст в голосе менеджера","category":"тема не этап скрипта","machineTypeIds":[],"tags":[]}]
}`;
